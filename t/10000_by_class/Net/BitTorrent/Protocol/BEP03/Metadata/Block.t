package t::Net::BitTorrent::Protocol::BEP03::Metadata::Block;
{
    use strict;
    use warnings;
    ...
    #
    sub class {'Net::BitTorrent::Protocol::BEP03::Metadata::Block'}
    ...
    sub moose_attributes : Test( 3 ) {
        my $s = shift;
        has_attribute_ok $s->{'m'}, $_, 'has ' . $_
            for qw[length complete timeout];
    }
