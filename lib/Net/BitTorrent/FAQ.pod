...
Bug reports?  Use the issues system provided by Google:
L<http://code.google.com/p/net-bittorrent/issues/list> rather than
CPAN's RT system.

Currently, I'm not actively looking for co maintainers, but if you
think you can bring order to the project, it doesn't hurt to contact
me.
