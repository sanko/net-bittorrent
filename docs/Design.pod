...
=head2 Net::BitTorrent::DHT::Standalone [Ext]

This class obviously extends Net::BitTorrent::DHT to function without a parent
...
=item Namespace plan v1.0
  ...
  *Net::BitTorrent::DHT                  class      todo/high
  *Net::BitTorrent::DHT::Standalone      ext class  done
  *Net::BitTorrent::DHT::Callbacks       role       todo/low
   Net::BitTorrent::DHT::Bucket?
   Net::BitTorrent::DHT::Node?
  *Net::BitTorrent::Network              base class todo (transfer limits?)
  *Net::BitTorrent::Network::TCP         ext class  done
  *Net::BitTorrent::Network::UDP         ext class  done
   Net::BitTorrent::Network::Utility                done
   Net::BitTorrent::Peer
   Net::BitTorrent::Storage              class
   Net::BitTorrent::Storage::Node        base class
   Net::BitTorrent::Storage::File        ext class
   Net::BitTorrent::Storage::Cache       ext class (subpiece cache)
   Net::BitTorrent::Torrent              class
   Net::BitTorrent::Torrent::Standalone  role
   Net::BitTorrent::Torrent::Factory     role?
...
These are packages I really haven't given enough thought to:
   ...
   Net::BitTorrent::Protocol::BEP03::Tracker::HTTP
                                                Single url
   Net::BitTorrent::Protocol::BEP05            Documentation
   Net::BitTorrent::Protocol::BEP05::Packets   Builds and parses DHT protocol packets
  ...
  *Net::BitTorrent::Protocol::BEP15::Tracker::UDP
                                                Single url
   Net::BitTorrent::Protocol::BEP23            compact/uncompact peer lists (IPv4)
